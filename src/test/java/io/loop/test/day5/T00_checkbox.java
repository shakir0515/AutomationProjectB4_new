...
public class T00_checkbox {
    public static void main(String[] args) {
        ...
        ////input[@type='checkbox' and following-sibling::input]
...
//4
        ...
        if(checkbox2.isSelected()){
            System.out.println("Checkbox two is selected");
        }else{
            System.out.println("Checkbox two is not selected");
        }
...
//        6. Confirm checkbox #1 is SELECTED.
        if(checkbox1.isSelected()){
            ...
            System.out.println("Checkbox one is not selected");
        }
